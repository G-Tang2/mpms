...
class Header(tk.Frame):
    ...
    def display_logout_btn(self):
        ...
        tk.Button(self.header_frame, image = self.logout_image, relief = 'flat', command = lambda: self.master.header_controller.logout(),borderwidth= 0, highlightthickness = 0 , height = 5, anchor="w", bg="#99d2f2").pack(side = "right", ipady=5)
        self.header_frame.pack(fill = 'x')
